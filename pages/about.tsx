      ...
      <main className="flex flex-col space-y-5 justify-center items-center !min-h-[80vh] px-20 text-center">
        ...
        <p className="space-y-1 pt-10">
          <h2 className="text-lg">
            ...
            opinion is what makes AI art so special.
          </h2>
          <h2 className="text-lg">
            Another common problem for AI art is authenticity. The art must be
            reproducible and at the same unique in the entire universe given the
            signature is the same. The Solana blockchain is perfect for
            guaranteeing the last missing piece of authenticated art: truly
