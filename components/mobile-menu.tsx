    ...
    <ul className="">
        <li>
            <ActiveLink activeClassName='active' href="/about">
                <a className="mob-nav-link text-secondary px-2 py-2 block text-xl rounded-md hover:bg-secondary hover:text-primary">About</a>
            </ActiveLink>
        </li>
        <li>
            <ActiveLink activeClassName='active' href="/create">
                <a className="mob-nav-link text-secondary px-2 py-2 block text-xl rounded-md hover:bg-secondary hover:text-primary">Create</a>
            </ActiveLink>
        </li>
        <li className=' pb-2'>
            <ActiveLink activeClassName='active' href="/explore">
                <a className="mob-nav-link text-secondary px-2 py-2 block text-xl rounded-md hover:bg-secondary hover:text-primary">Explore</a>
            </ActiveLink>
        </li>
        <li>
