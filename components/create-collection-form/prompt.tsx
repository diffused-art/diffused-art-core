...
import TextareaInput from '../form/base/textarea-input';
...
export default function CreateCollectionFormPrompt() {
  ...
  const generateAIPreviewImage = useCallback(async () => {
    ...
    return axios
      ...
      .catch(error => {
        toast({
          message: JSON.stringify(error?.response?.data) || 'Server error',
    ...
    <>
      <div className="py-10 flex justify-center px-2">
        <div className="w-full container mx-auto">
          ...
          <Title className="flex justify-between items-center md:pt-8">
            Prompt your imagination{' '}
            <a
              href="https://docs.diffused.art/dream/artist-guide#first-step-prompting"
              target="_blank"
              rel="noreferrer"
              className="text-sm text-main-yellow hover:opacity-70"
            >
          ...
          >
            ...
            <div className="flex flex-col-reverse md:grid md:grid-cols-2 md:space-x-5">
              ...
              <div>
                <div className="pt-6 rounded-sm flex flex-col justify-center items-center px-5">
                  <div className="relative">
                    {loadingPreviewImage && (
                      <>
                        <div className="absolute w-full h-full bg-gray-100 rounded-md opacity-20"></div>
